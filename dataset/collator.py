...
def collate_fn(batch):
    ...
    graph, num_mention, num_entity, num_sent, num_virtual, num_token = graph_builder.create_graph(batch_entity_pos, batch_sent_pos, batch_virtual_pos, batch_token_pos)
