...
class GraphBuilder:
    ...
    def create_graph(self, batch_entity_pos, batch_sent_pos, batch_virtual_pos, batch_token_pos):
        ...
        mention_to_tokens_edges = get_mention_to_tokens_edges(num_mention, num_token, batch_entity_pos, batch_virtual_pos, batch_token_pos)
        ...
        edge_u, edge_v = mention_to_tokens_edges
        for edge_id in range(len(edge_u)):
            u.append(edge_u[edge_id])
        ...
        return graph, num_mention, num_entity, num_sent, num_token
