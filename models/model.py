...
class GCN(nn.Module):
    ...
    def get_virtual_embed(self, sequence_output, batch_virtual_pos, num_virtual):
        ...
        for batch_id, virtual_posies in enumerate(batch_virtual_pos):
            mention_id = 0
            for virtual_pos in virtual_posies:
                virtual_embed[batch_id, mention_id] = sequence_output[batch_id, virtual_pos[0] + self.offset]
                mention_id += 1
